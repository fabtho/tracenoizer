...
#$rainbow =`/usr/local/bin/rainbow --append-stoplist-file=/home/tracenoizer/traceintern/stoplist -H -d /home/tracenoizer/public_html/model -i /home/tracenoizer/public_html/temp/$main_id/* 2>&1`;
#print "$rainbow.\n";   
