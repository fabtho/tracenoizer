...
echo "<url: http://www.cygwin.com/ >. Then run bin/unix/e-xcompile"
:: Email me, if you've fixed or tested this batch file, thanks!

:: BatchCompile: byte compiles its args for faster loading
...
::Syntax: xcompile foo.el bar.el *.el
...
:run
xemacs -batch -l %HOME%/emacs/e-path.el -f batch-byte-compile %1 %2 %3 %4 %5 %6 %7 %8 %9
goto end
