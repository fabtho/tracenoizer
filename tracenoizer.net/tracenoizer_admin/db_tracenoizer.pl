...
######################################### MAIN 
 tablecreate("create table main(main_id int not null auto_increment, Index(main_id),
			main_date date,main_usr_id int, index(main_usr_id),main_generation int, index(main_generation),main_weblink tinytext, 
...
tablecreate("create table keyword(keyword_id int  not null auto_increment, Index(keyword_id),
			keyword_main_id int, index(keyword_main_id),keyword char (255), index (keyword), keyword_infog float(11,9),keyword_html text, keyword_size
...
######################################### WORDCOUNT 
tablecreate("create table wordcount(wordcount_id int not null auto_increment, Index(wordcount_id), wordcount_tx_id int not null,index(wordcount_tx_id),
