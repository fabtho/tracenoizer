...
sub generation_loop{
    ...
    my $abfrage= $dbh->prepare("select main_id,main_usr_id from main where main_generation = '$main_generation' and main_st_id = 7 and 
main_id > 27655");
    $abfrage->execute;
    my $main_id = 0;
    my $main_usr_id = "";
	...
	print "/usr/bin/perl /home/tracenoizer/traceintern/klon_central.pl $main_id $new_main_id $main_usr_id\n";  
	system "/usr/bin/perl /home/tracenoizer/traceintern/klon_central.pl $main_id $new_main_id $main_usr_id";
